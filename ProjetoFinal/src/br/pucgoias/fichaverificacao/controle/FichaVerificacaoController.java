...
public class FichaVerificacaoController
{
	...
	public String incluir()
	{
		...
		{
			String msg = "Inclusão não realizada. Motivo: "
	...
	public String listar()
	{
		...
		{
			String msg = "Listagem não realizada. Motivo: "
					+ ((e instanceof FichaVerificacaoException ? ((FichaVerificacaoException) e)
							.getEx().getMessage() : ""));
			FacesMessage message = new FacesMessage(msg);
			this.getFacesContext().addMessage("formulario", message);
	...
	public String consultar()
	{
		...
		{
			String msg = "Consulta não realizada. Motivo: "
					+ ((e instanceof FichaVerificacaoException ? ((FichaVerificacaoException) e)
							.getEx().getMessage() : ""));
			FacesMessage message = new FacesMessage(msg);
			this.getFacesContext().addMessage("formulario", message);
	...
	public String criar()
	{
		...
		{
			String msg = "Criação não realizada. Motivo: "
					+ ((e instanceof FichaVerificacaoException ? ((FichaVerificacaoException) e)
							.getEx().getMessage() : ""));
			FacesMessage message = new FacesMessage(msg);
			this.getFacesContext().addMessage("formulario", message);
	...
	public String excluir()
	{
		...
		{
			String msg = "Exclusão não realizada. Motivo: "
					+ ((e instanceof FichaVerificacaoException ? ((FichaVerificacaoException) e)
							.getEx().getMessage() : ""));
			FacesMessage message = new FacesMessage(msg);
			this.getFacesContext().addMessage("formulario", message);
	...
	public String alterar()
	{
		try
		{
			...
			getFichaVerificacaoService().alterar(fichaVerificacao);
		...
		{
			String msg = "Alteração não realizada. Motivo: "
					+ ((e instanceof FichaVerificacaoException ? ((FichaVerificacaoException) e)
							.getEx().getMessage() : ""));
			FacesMessage message = new FacesMessage(msg);
			this.getFacesContext().addMessage("formulario", message);
	...
	public void setFichaVerificacaoService(FichaVerificacaoService fichaVerificacaoService)
	{
	...
	public void setFichaVerificacaoBean(FichaVerificacaoBean fichaVerificacaoBean)
	{
		this.fichaVerificacaoBean = fichaVerificacaoBean;
	}

	public List<FichaVerificacaoBean> getListaFichaVerificacaoBean()
	{
		return listaFichaVerificacaoBean;
	}

	public void setListaFichaVerificacaoBean(List<FichaVerificacaoBean> listaFichaVerificacaoBean)
	{
